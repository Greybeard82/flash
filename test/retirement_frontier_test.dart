// planRetirement — which rows have scrolled far enough to be *queued* for
// retirement.
//
// Since pass 12 the plan is an enqueue list, not a delete list: nothing is
// removed and no scroll offset is corrected until a flush, so the only thing
// that must be exactly right here is which rows are eligible. An off-by-one
// queues an article the user can still see, and it disappears at the next
// flush.
//
