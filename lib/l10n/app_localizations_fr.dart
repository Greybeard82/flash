...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get backupSuccess => 'Sauvegarde enregistrée';

  @override
  String get exportDialogTitle => 'Enregistrer le fichier de sauvegarde';
  ...
  String alertKeywordExists(String keyword) {
    return '« $keyword » est déjà un mot-clé d’alerte';
  }
  ...
  String get aiSummaryFailed =>
      'Impossible de générer un résumé pour le moment.';
  ...
  String get aiSummaryDisclaimerCloud =>
      'Généré par Gemini dans le cloud. Peut contenir des erreurs.';
  ...
  @override
  String get iconBadge => 'Pastille de l\'icône';
  ...
  @override
  String get alertsRemove => 'Retirer';

  @override
  String get alertsRemovedBanner => 'Retiré des alertes';
  ...
  @override
  String get alertsArticleGone => 'Cet article n\'est plus dans votre flux';
  ...
  String deleteAlertKeywordBody(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count articles disparaîtront de l\'onglet Alertes.',
      one: '$count article disparaîtra de l\'onglet Alertes.',
    );
    return '$_temp0';
  }

  @override
  String get alertNotificationTitle => 'Flash — alerte mot-clé';

  @override
  String alertNotificationFirst(String keyword) {
    return '\"$keyword\" est apparu dans un article';
  }
  ...
  String alertNotificationCount(int count, String keyword) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count articles correspondent à \"$keyword\"',
      one: '$count article correspond à \"$keyword\"',
    );
    return '$_temp0';
  }
  ...
  String alertNotificationCombined(int count, String keywords) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count articles contiennent les mots $keywords',
      one: '$count article contient les mots $keywords',
    );
    return '$_temp0';
  }
  ...
  @override
  String get every4Hours => 'Toutes les 4 heures';

  @override
  String get every5Hours => 'Toutes les 5 heures';

  @override
  String get refreshOnWifiOnly => 'Actualiser uniquement en Wi-Fi';
  ...
  @override
  String get onboardingStarterTitle => 'Commencez avec quelques flux';

  @override
  String get onboardingStarterSubtitle =>
      'Des médias connus, classés par catégories. Vous pourrez en retirer à tout moment.';

  @override
  String get startReadingButton => 'Commencer à lire';

  @override
  String get skipAddOwnFeedsButton => 'Passer, j\'ajouterai les miens';

  @override
  String get addStarterPackButton => 'Ajouter le pack de départ';

  @override
  String get starterPackSheetTitle => 'Pack de départ';
  ...
  String starterPackAddedBanner(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count flux ajoutés',
      one: '1 flux ajouté',
      zero: 'Aucun nouveau flux ajouté',
    );
    return '$_temp0';
  }

  @override
  String get starterCategoryWorldNews => 'Actualité internationale';

  @override
  String get starterCategoryTech => 'Tech';

  @override
  String get starterCategoryFitnessHealth => 'Forme / Santé';

  @override
  String get starterCategoryTravel => 'Voyages';
