...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get aiSummaryFailed =>
      'Zusammenfassung konnte gerade nicht erstellt werden.';
  ...
  String get aiSummaryDisclaimerCloud =>
      'In der Cloud von Gemini erstellt. Kann Fehler enthalten.';
  ...
  @override
  String get every2Hours => 'Alle 2 Stunden';

  @override
  String get every4Hours => 'Alle 4 Stunden';

  @override
  String get every5Hours => 'Alle 5 Stunden';

  @override
  String get refreshOnWifiOnly => 'Nur über WLAN aktualisieren';
  ...
  @override
  String get onboardingStarterTitle => 'Mit ein paar Feeds beginnen';

  @override
  String get onboardingStarterSubtitle =>
      'Bekannte Medien, nach Kategorien sortiert. Du kannst sie später jederzeit entfernen.';

  @override
  String get startReadingButton => 'Lesen beginnen';

  @override
  String get skipAddOwnFeedsButton => 'Überspringen, ich füge eigene hinzu';

  @override
  String get addStarterPackButton => 'Startpaket hinzufügen';

  @override
  String get starterPackSheetTitle => 'Startpaket';
  ...
  String addStarterFeedsButton(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Feeds hinzufügen',
      one: '1 Feed hinzufügen',
    );
    return '$_temp0';
  }
  ...
  String starterPackAddedBanner(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Feeds hinzugefügt',
      one: '1 Feed hinzugefügt',
      zero: 'Keine neuen Feeds hinzugefügt',
    );
    return '$_temp0';
  }

  @override
  String get starterCategoryWorldNews => 'Weltnachrichten';

  @override
  String get starterCategoryTech => 'Technik';

  @override
  String get starterCategoryFitnessHealth => 'Fitness / Gesundheit';

  @override
  String get starterCategoryTravel => 'Reisen';
  ...
  @override
  String get emailUs => 'Schreib uns';
  ...
  String get opmlSubtitle =>
      'Übertrage deine Feeds zu oder von einem anderen Reader. Der Import ergänzt deine Feeds und ersetzt sie nie.';

  @override
  String get importOpml => 'OPML importieren';
  ...
  String opmlImportedBanner(int feeds, int folders, int skipped) {
    return 'Feeds hinzugefügt: $feeds · Kategorien erstellt: $folders · Übersprungen: $skipped';
  }

  @override
  String get opmlImportFailed =>
      'Diese Datei ist keine gültige OPML-Datei. Es wurde nichts geändert.';

  @override
  String get opmlImportedFolderName => 'Importiert';
